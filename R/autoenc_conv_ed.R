...
#'ae <- autoenc_conv_ed(input_size = 20, encoding_size = 5, num_epochs = 100)
...
#'@import reticulate
#'@export
autoenc_conv_ed <- function(input_size, encoding_size, batch_size = 32, num_epochs = 100L, learning_rate = 0.001,
...
fit.autoenc_conv_ed <- function(obj, data, ...) {
  ...
  result <- autoenc_conv_fit(obj$model, data, batch_size = obj$batch_size, num_epochs = obj$num_epochs, learning_rate = obj$learning_rate,
