...
#'ae <- autoenc_adv_e(input_size = 20, encoding_size = 5, num_epochs = 100)
...
#'@import reticulate
#'@export
autoenc_adv_e <- function(input_size, encoding_size, batch_size = 350, num_epochs = 100L, learning_rate = 0.001,
