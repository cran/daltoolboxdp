...
#'ae <- autoenc_denoise_ed(input_size = 20, encoding_size = 5, noise_factor = 0.2, num_epochs = 100)
...
#'@import reticulate
#'@export
autoenc_denoise_ed <- function(input_size, encoding_size, batch_size = 32, num_epochs = 100L, learning_rate = 0.001, noise_factor=0.3,
...
fit.autoenc_denoise_ed <- function(obj, data, ...) {
  ...
  result <- autoenc_denoise_fit(obj$model, data, batch_size = obj$batch_size, num_epochs = obj$num_epochs, learning_rate = obj$learning_rate,
